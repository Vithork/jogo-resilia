...
amazona = '''
                  ...
                  `\~--.._     //'            ,(+=\\\\
                   `//////\  \\/;'             /~ (\\\\'                            ____________________________________________________________
                     ~/////\~\`)'             /;   ))))                            ||                                                         ||
                         `~'  |              ((`~/((((\'                           <> As amazonas são fortes guerreiras que vivem na floresta, <>
                         ;'_\'\             /'))   )))))                           || protetoras da natureza,além de tudo são grandes aventu-  ||
                        /~/ '" "'     _.  /'/\_ /^\`((( \'                         <> reiras e estão preparadas para alcançar seus objetivos   <>
                       `\/'       _.-~/--/ (  =(   | ,  |                          || independente do tamanho do desafio.                     ||
                               _/~\_)_}___/^\/~`\.__\|==|                          <> Você chegou de navio em Kwame, e logo soube que muitas  <>
                              /uUUU)        )        |  |                          || aventuras a aguardavam.                                 ||
                             (   / |      _-=o|\__ /'/~ \'                          <>                                                         <>
                             ' /'  |     /(((((\`\(  |~\/                          ||                                                         ||
                             /'    |   /' )))))"`\`\|/_/---.._,$$,                  <>                                                        <>
                       .,ssS$$$Sss|._/_..-((('    )\)>>>      ~\$                  ||                                                         ||
